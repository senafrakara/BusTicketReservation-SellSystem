...
//if(isset($_POST['Seat']) && isset($_POST['Gender'])){
//	$seatNum = $_POST['Seat'];
//	$gender = $_POST['Gender'];
//}

    echo '<form  id="form1" action="paymentReservedTicket.php" method="POST"> 
	<input type="text" name="pnr" id="pnr" placeholder="Write Pnr number" required>
